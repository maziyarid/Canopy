...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BH7Ie9M0.mjs");
...
var manifest = {
	"5b738a0d7db0c8f22a3da300c948d1433c0c697de7162b763d83c97c20e8bc9b": {
		functionName: "runResearchAgent_createServerFn_handler",
		importer: () => import("./agent-FQROeaSw.mjs")
	},
	"db4438b6ba10af6a780134d542f6ebbf5864d1ed44e8cdac6b1803e487453678": {
		functionName: "mangoolsRequest_createServerFn_handler",
		importer: () => import("./mangools-DdooEcdC.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Dnh0gw_j.mjs").then((n) => n.t),
